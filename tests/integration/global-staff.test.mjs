...
test("global staff viewing preserves assigned-officer writes, evidence and citizen privacy",async()=>{
 const db=new PGlite();
 try{
 await db.exec(`
 ...
 `);
 for(const file of ["202609110001_foundation.sql","202609110002_identity.sql","202609110003_reporting.sql","202609130004_municipal_workflow.sql","202609130005_global_staff_visibility.sql"])
